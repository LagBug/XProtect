...
public class MapBuilder {
    ...
    public MapBuilder() {
        ...
        rendered = false;
        renderOnce = true;
        isNewerVersion = Utils.getServerVersion() >= 13;
    }
    ...
    public ItemStack build() {
        ItemStack item = new ItemStack(isNewerVersion ? Material.MAP : Material.valueOf("MAP"));
...
class Text {
    ...
    public Text(int x, int y, MapFont font, String message) {
        setX(x);
        setY(y);
        setFont(font);
        setMessage(message);
